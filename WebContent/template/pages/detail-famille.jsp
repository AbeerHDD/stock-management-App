...
<head>
    ...
    <title>Détails d'une Famille</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Détails d'une Famille</h4> </div>
                 ...
                 <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title">Détails d'une Famille</h3>
                        ...
                        <div class="col-xs-12">
                           <label>Nom Famille :</label>
                            <input class="form-control" type="text" name="nom_famille" value="<c:out value="${famille.nom_famille}" />" placeholder="Nom de la famille" disabled> </div>
                    </div>
                               
                               <div class="form-group m-t-20">
                        <div class="col-xs-12">
                        <label>Description :</label>
                            <input class="form-control" type="text"  name="description" value="<c:out value="${famille.description}" />" placeholder="Description" disabled></div>
                            </div>
