            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Liste des Devis</h4> </div>
                        ...
                        <div class="white-box">
                            ...
                            <div class="table-responsive">
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                             <tr>       
                                   <c:forEach var="devis" items="${list.rows}">
					<tr>
						<td><c:out value="${devis.client}" /></td>
						<td><c:out value="${devis.date}" /></td>
						<td><c:out value="${devis.reglement}" /></td>
					<td>
						<c:url value="/template/pages/detail-devis.jsp" var="update_url">
								<c:param name="id" value="${devis.id}" />
						</c:url> 
						...
						<c:url value="/template/pages/modifier-devis.jsp" var="update_url">
								<c:param name="id" value="${devis.id}" />
						</c:url> 
							<a href="<c:out value="${update_url}" />" >
						...
						<c:url value="/template/pages/delete_devis.jsp" var="delete_url">
								<c:param name="id" value="${devis.id}" />
						</c:url> 
