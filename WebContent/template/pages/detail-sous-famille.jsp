...
<head>
    ...
    <title>Détails d'une Sous Famille</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Détails d'une Sous Famille</h4> </div>
                 ...
                 <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title">Détails d'une Sous Famille</h3>
                              <c:forEach var="sous_famille" items="${list.rows}">
                              
                            <form class="form-material form-horizontal" method="POST">
                                <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Nom de Sous Famille :</label>
                            <input class="form-control" type="text" name="nom_sous_famille" value="<c:out value="${sous_famille.nom_sous_famille}" />" placeholder="Nom de la sous famille" disabled> </div>
                    </div>
                             <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>TVA :</label>
                            <input class="form-control" type="text" name="adresse" value="<c:out value="${sous_famille.tva}" />" placeholder="Adresse" disabled> </div>
                    </div>
                        ...
                        <div class="col-xs-12">
                            ...
                            <input class="form-control" type="text"  name="description" value="<c:out value="${sous_famille.description}" />" placeholder="Description" disabled></div>
                            </div>
