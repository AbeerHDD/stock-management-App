...
<head>
    ...
    <title>Détails d'unFournisseur</title>
    <!-- Bootstrap Core CSS -->
...
select * from fournisseur where id = '<c:out value="${param.id}" />' ; 
</sql:query>
    <!-- Preloader -->
    <div class="preloader">
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Détails d'unfournisseur</h4> </div>
                 ...
                 <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title">Détails d'un fournisseur</h3>
                            
                              <c:forEach var="fournisseur" items="${list.rows}">
                              
                            <form class="form-material form-horizontal" action="update_fournisseur.jsp" method="POST">
                                <div class="form-group m-t-20">
                        <div class="col-xs-12">
                           <label>Code :</label>
                            <input class="form-control" type="text" name="code" value="<c:out value="${fournisseur.code}" />" placeholder="Code" disabled> </div>
                    </div>
                               
                              <div class="form-group m-t-20">
                        <div class="col-xs-12">
                        <label>Raison Sociale :</label>
                            <input class="form-control" type="text" name="raison_sociale" value="<c:out value="${fournisseur.raison_sociale}" />" placeholder="Raison Sociale" disabled> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Résponsable :</label>
                            <input class="form-control" type="text" name="responsable" value="<c:out value="${fournisseur.responsable}" />" placeholder="Résponsable" disabled> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                          <label>Matricule Fiscale :</label>
                            <input class="form-control" type="text" name="matricule_fiscale" value="<c:out value="${fournisseur.matricule_fiscale}" />" placeholder="Matricule Fiscale" disabled> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Téléphone :</label>
                            <input class="form-control" type="text" name="telephone" value="<c:out value="${fournisseur.telephone}" />" placeholder="Téléphone" disabled> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                           <label>Fax :</label>
                            <input class="form-control" type="text" name="fax" value="<c:out value="${fournisseur.fax}" />" placeholder="Fax" disabled> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                           <label>Email :</label>
                            <input class="form-control" type="text" name="email" value="<c:out value="${fournisseur.email}" />" placeholder="Email" disabled> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Adresse :</label>
                            <input class="form-control" type="text" name="adresse" value="<c:out value="${fournisseur.adresse}" />" placeholder="Adresse" disabled> </div>
                    </div>
                      <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Ville :</label>
                            <input class="form-control" type="text" name="adresse" value="<c:out value="${fournisseur.ville}" />" placeholder="Adresse" disabled> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                          <label>Code Postal :</label>
                            <input class="form-control" type="text" name="code_postal" value="<c:out value="${fournisseur.code_postal}" />" placeholder="Code Postal" disabled> </div>
                    </div>
                    
                     <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Mode de Paiement Préféré :</label>
                            <input class="form-control" type="text" name="paiement" value="<c:out value="${fournisseur.paiement}" />" placeholder="Mode de Paiement Préféré" disabled> </div>
                    </div>
