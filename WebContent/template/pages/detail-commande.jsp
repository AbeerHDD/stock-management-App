                    ...
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                           <label>ID Devis :</label>
                            <input class="form-control" type="number" name="id_devis" value="<c:out value="${commande.id_devis}" />" placeholder="Nom de la famille" disabled> </div>
                    </div>
                               
                               <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Num Commande :</label>
                            <input class="form-control" type="text" name="numcommande" value="<c:out value="${commande.numcommande}" />" placeholder="Nom de la famille" disabled> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Client :</label>
                            <input class="form-control" type="text" name="client" value="<c:out value="${commande.client}" />" placeholder="Nom de la famille" disabled> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Date :</label>
                            <input class="form-control" type="date" name="date" value="<c:out value="${commande.date}" />" placeholder="Nom de la famille" disabled> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Notes :</label>
                            <input class="form-control" type="text" name="notes" value="<c:out value="${commande.notes}" />" placeholder="Nom de la famille" disabled> </div>
                    </div>
                               <p></p>
