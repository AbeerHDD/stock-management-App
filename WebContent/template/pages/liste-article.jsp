            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Liste des Arcticles</h4> </div>
                ...
                <div class="row">
                 ...
                 <div class="col-sm-10">
						...
						<td><c:out value="${article.libille}" /></td>
						<td><c:out value="${article.famille}" /></td>
						<td><c:out value="${article.sous_famille}" /></td>
						
						
						<td>
						<c:url value="/template/pages/detail-article.jsp" var="update_url">
						...
						<c:url value="/template/pages/modifier-article.jsp" var="update_url">
								<c:param name="id" value="${article.id}" />
						</c:url> 
							<a href="<c:out value="${update_url}" />" >
						...
						<c:url value="/template/pages/delete_article.jsp" var="delete_url">
								<c:param name="id" value="${article.id}" />
						</c:url> 
