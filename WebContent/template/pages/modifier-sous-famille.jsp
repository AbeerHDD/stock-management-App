            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Modifier Sous Famille</h4> </div>
                 ...
                 <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title">Modifier Sous Famille</h3>
                              <c:forEach var="sous_famille" items="${list.rows}">
                              
                            <form class="form-material form-horizontal" action="update_sous_famille.jsp" method="POST">
                            <input class="form-control" type="hidden" name="id" value="${sous_famille.id}">
                                <div class="form-group m-t-20">
                        <div class="col-xs-12">
                          <label>Nom Sous Famille :</label>
                            <input class="form-control" type="text" name="nom_sous_famille" value="<c:out value="${sous_famille.nom_sous_famille}" />" placeholder="Nom de la sous famille"> </div>
                    </div>
  ...
  <option value="22">22</option>
                        ...
                        <div class="col-xs-12">
                          <label>Description :</label>
                            <input class="form-control" type="text"  name="description" value="<c:out value="${sous_famille.description}" />" placeholder="Description" ></div>
                            </div>
