...
<div class="navbar-default sidebar" role="navigation">
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Modifier Facture</h4> </div>
                 ...
                 <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <form class="form-material form-horizontal" action="update_facture.jsp" method="POST">
                            <input class="form-control" type="hidden" name="id" value="${facture.id}">
                                <div class="form-group m-t-20">
                        <div class="col-xs-12">
                           <label>ID Commande :</label>
                            <input class="form-control" type="number" name="id_commande" value="<c:out value="${facture.id_commande}" />" placeholder="Nom de la famille"> </div>
                    </div>
                               
                               <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Num Facture :</label>
                            <input class="form-control" type="number" name="numfacture" value="<c:out value="${facture.numfacture}" />" placeholder="Nom de la famille"> </div>
                    </div>
                    
                    <select class="form-control" name="client">
                    <option >Client</option>
                     <c:forEach var="client" items="${list1.rows}">
  ...
  <option value="<c:out value="${client.nom}"/>" value="<c:out value="${client.prenom}"/>"><c:out value="${client.nom}" /> <c:out value="${client.prenom}" />  </option> 
                    ...
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Date :</label>
                            <input class="form-control" type="date" name="date" value="<c:out value="${facture.date}" />" placeholder="Nom de la famille"> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Prix :</label>
                            <input class="form-control" type="number" name="prix" value="<c:out value="${facture.prix}" />" placeholder="Nom de la famille"> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Paiement :</label>
                            <input class="form-control" type="text" name="paiement" value="<c:out value="${facture.paiement}" />" placeholder="Nom de la famille"> </div>
                    </div>
                               <p></p>
