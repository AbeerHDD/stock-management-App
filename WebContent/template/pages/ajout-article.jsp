...
<%@page import="com.Gestion_Stock.controllers.*"%>
<%@page import="com.Gestion_Stock.models.*"%>
...
<div class="navbar-default sidebar" role="navigation">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row bg-title">
                 ...
                 <div class="col-sm-8">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Ajouter un Article</h3>
                           
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                
                               <form class="form-horizontal form-material" action="add_article.jsp" method="POST">
                 
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <input class="form-control" type="text" name="designation" placeholder="Désignation"> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <input class="form-control" type="text" name="libille" placeholder="Libillé"> </div>
                    </div>
  ...
  <option  value="sans unite">sans unité</option>
</select>
                  </div>
                  <p></p>
                   <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <input class="form-control" type="text" name="prix" placeholder="Prix"> </div>
                    </div>
                  <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <input class="form-control" type="text" name="quantite" placeholder="Quantité"> </div>
                    </div>
                   <div class="form-label-group">
                    ...
                    <option >Famille</option>
                     <c:forEach var="famille" items="${list.rows}">
 ...
 <c:forEach var="sous_famille" items="${list1.rows}">
