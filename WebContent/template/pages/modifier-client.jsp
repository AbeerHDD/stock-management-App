            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Modifier un Client</h4> </div>
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                          ...
                          <c:forEach var="client" items="${list.rows}">
                            ...
                            <form class="form-material form-horizontal" action="update_client.jsp" method="POST">
                               
                           <input class="form-control" type="hidden" name="id" value="${client.id}">
                  <h5 class="box-title m-t-40 m-b-0">Modifier un Client</h5>
                    
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                             <label>Nom :</label>
                            <input class="form-control" type="text" name="nom" value="<c:out value="${client.nom}"/>" placeholder="Nom"> </div>
                    </div>
                    
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                              <label>Prénom :</label>
                             <input class="form-control" type="text" name="prenom" value="<c:out value="${client.prenom}"/>" placeholder="Prénom"> </div>
                    </div>
...
<div class="form-group m-t-20">
                        ...
                        <div class="col-xs-12">
                            ...
                            <input class="form-control" type="text" name="matricule_fiscale" value="<c:out value="${client.matricule_fiscale}"/>" placeholder="Matricule Fiscale"> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Téléphone :</label>
                            <input class="form-control" type="number" name="telephone" value="<c:out value="${client.telephone}"/>" placeholder="Téléphone"> </div>
                    </div>
                    <div class="form-group ">
                        <div class="col-xs-12">
                             <label>Email :</label>
                            <input class="form-control" type="text" name="email" value="<c:out value="${client.email}"/>" placeholder="Email"> </div>
                    </div>
                    <div class="form-group ">
                        <div class="col-xs-12">
                           <label>Adresse :</label>
                             <input class="form-control" type="text" name="adresse" value="<c:out value="${client.adresse}"/>" placeholder="Adresse"> </div>
                    </div>
  ...
  <option value="zaghouane">Zaghouane</option>
                    ...
                    <div class="col-xs-12">
                            ...
                            <input class="form-control" type="number" name="code_postal" value="<c:out value="${client.code_postal}"/>" placeholder="Code Postal"> </div>
