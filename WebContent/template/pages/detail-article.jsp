            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Détails d'un Article</h4> </div>
                   ...
                   <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Détails d'un Article</h3>
                    ...
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            ...
                            <input class="form-control" type="text" name="designation" value="<c:out value="${article.designation}"/>"  placeholder="Désignation" disabled> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Libillé :</label>
                            <input class="form-control" type="text" name="libille" value="<c:out value="${article.libille}" />" placeholder="Libillé" disabled> </div>
                    </div>
                  <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Unité :</label>
                            <input class="form-control" type="text" name="unite" value="<c:out value="${article.unite}" />" placeholder="Libillé" disabled> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Prix :</label>
                            <input class="form-control" type="text" name="prix" value="<c:out value="${article.prix}" />" placeholder="Libillé" disabled> </div>
                    </div>
                  
                  <div class="form-group m-t-20">
                        <div class="col-xs-12">
                           <label>Quantité :</label>
                            <input class="form-control" type="text" name="quantite" value="<c:out value="${article.quantite}" />" placeholder="Quantité" disabled> </div>
                    </div>
                   <div class="form-group m-t-20">
                        <div class="col-xs-12">
                           <label>Famille :</label>
                            <input class="form-control" type="text" name="famille" value="<c:out value="${article.famille}" />" placeholder="famille" disabled> </div>
                    </div>
                  <div class="form-group m-t-20">
                        <div class="col-xs-12">
                           <label> Sous Famille :</label>
                            <input class="form-control" type="text" name="sous_famille" value="<c:out value="${article.sous_famille}" />" placeholder="sous_famille" disabled> </div>
                    </div>
