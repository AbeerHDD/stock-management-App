...
<div class="navbar-default sidebar" role="navigation">
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Modifier un Utilisateur</h4> </div>
                   ...
                   <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Modifier un Utilisateur</h3>
                 ...
                 <input class="form-control" type="hidden" name="id" value="${utilisateur.id}">
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                           <label>Nom :</label>
                            <input class="form-control" type="text" name="nom" value="<c:out value="${utilisateur.nom}" />" placeholder="Nom"> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Prénom :</label>
                            <input class="form-control" type="text" name="prenom" value="<c:out value="${utilisateur.prenom}" />" placeholder="Prénom"> </div>
                    </div>
   ...
   <option>Sexe</option>                 
  <option value="<c:out value="${utilisateur.sexe}" />">Homme</option>
  <option value="<c:out value="${utilisateur.sexe}" />">Femme</option>
   ...
   <option>Poste</option>                 
  <option value="<c:out value="${utilisateur.poste}" />">Administrateur</option>
  <option value="<c:out value="${utilisateur.poste}" />">Caissier</option>
                    ...
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                          <label>Téléphone :</label>
                            <input class="form-control" type="number" min="20000000" max="99999999"  name="telephone" value="<c:out value="${utilisateur.telephone}" />" placeholder="Téléphone"> </div>
                    </div>
                    <div class="form-group ">
                        <div class="col-xs-12">
                          <label>Email :</label>
                            <input class="form-control" type="email" name="email" value="<c:out value="${utilisateur.email}" />" placeholder="Email"> </div>
                    </div>
