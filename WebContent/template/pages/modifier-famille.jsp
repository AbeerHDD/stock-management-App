...
select * from famille where id = '<c:out value="${param.id}" />' ; 
</sql:query>
    <!-- Preloader -->
    <div class="preloader">
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Modifier une Famille</h4> </div>
                 ...
                 <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title">Modifier une Famille</h3>
                              <c:forEach var="famille" items="${list.rows}">
                              
                            <form class="form-material form-horizontal" action="update_famille.jsp" method="POST">
                            <input class="form-control" type="hidden" name="id" value="${famille.id}">
                                <div class="form-group m-t-20">
                        <div class="col-xs-12">
                           <label>Nom de la Famille :</label>
                            <input class="form-control" type="text" name="nom_famille" value="<c:out value="${famille.nom_famille}" />" placeholder="Nom de la famille"> </div>
                    </div>
                               
                               <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Description :</label>
                            <input class="form-control" type="text" name="description" value="<c:out value="${famille.description}" />" placeholder="Nom de la famille"> </div>
                    </div>
                               <p></p>
