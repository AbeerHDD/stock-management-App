...
select * from utilisateur where id = '<c:out value="${param.id}" />' ; 
</sql:query>
    <!-- Preloader -->
    <div class="preloader">
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Détails d'un Utilisateur</h4> </div>
                   ...
                   <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Détails d'un Utilisateur</h3>
                           
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                              <c:forEach var="utilisateur" items="${list.rows}">
                    ...
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                             <label>Nom :</label>
                             <input class="form-control" type="text" name="nom" value="<c:out value="${utilisateur.nom}" />" placeholder="Nom" disabled> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Prénom :</label>
                            <input class="form-control" type="text" name="prenom" value="<c:out value="${utilisateur.prenom}" />" placeholder="Prénom" disabled> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Sexe :</label>
                            <input class="form-control" type="text" name="prenom" value="<c:out value="${utilisateur.sexe}" />" placeholder="Sexe" disabled> </div>
                    </div>
       <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Poste :</label>
                            <input class="form-control" type="text" name="prenom" value="<c:out value="${utilisateur.poste}" />" placeholder="Poste" disabled> </div>
                    </div>

                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Téléphone :</label>
                            <input class="form-control" type="tel" name="telephone" value="<c:out value="${utilisateur.telephone}" />" placeholder="Téléphone" disabled> </div>
                    </div>
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <label>Email :</label>
                            <input class="form-control" type="text" name="email" value="<c:out value="${utilisateur.email}" />" placeholder="Email" disabled> </div>
                    </div>
