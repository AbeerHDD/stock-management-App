                                ...
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                           ...
                                           <tr>
                        <td><c:out value="${sous_famille.nom_sous_famille}" /></td>
						<td><c:out value="${sous_famille.tva}" /></td>
						<td><c:out value="${sous_famille.description}" /></td>
						
						
					<td>
						<c:url value="/template/pages/detail-sous-famille.jsp" var="update_url">
								<c:param name="id" value="${sous_famille.id}" />
						</c:url> 
						...
						<c:url value="/template/pages/modifier-sous-famille.jsp" var="update_url">
								<c:param name="id" value="${sous_famille.id}" />
						</c:url> 
							<a href="<c:out value="${update_url}" />" >
						...
						<c:url value="/template/pages/delete_sous_famille.jsp" var="delete_url">
								<c:param name="id" value="${sous_famille.id}" />
						</c:url> 
