...
<div class="navbar-default sidebar" role="navigation">
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Ajouter un Fournisseur</h4> </div>
                 ...
                 <div class="col-sm-8">
                        <div class="white-box">
                            ...
                            <form class="form-material form-horizontal" action="add_fournisseur.jsp" method="POST">
                               
                           
                  <h5 class="box-title m-t-40 m-b-0">Ajouter un Fournisseur</h5>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <input class="form-control" type="text" name="code" placeholder="Code"> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <input class="form-control" type="text" name="raison_sociale" placeholder="Raison Sociale"> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <input class="form-control" type="text" name="responsable" placeholder="Résponsable"> </div>
                    </div>
                    
                  <div class="form-group m-t-20">

                        <div class="col-xs-12">
                            <input class="form-control" type="text" name="matricule_fiscale" placeholder="Matricule Fiscale"> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <input class="form-control" type="number" min="20000000" max="99999999"  name="telephone" placeholder="Téléphone"> </div>
                    </div>
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input class="form-control" type="text" name="fax" placeholder="Fax"> </div>
                    </div>
                    <div class="form-group ">
                        <div class="col-xs-12">
                    ...
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input class="form-control" type="text" name="adresse" placeholder="Adresse"> </div>
                    </div>
  ...
  <option value="zaghouane">Zaghouane</option>
                    ...
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input class="form-control" type="number" name="code_postal" placeholder="Code Postal"> </div>
                    </div>
