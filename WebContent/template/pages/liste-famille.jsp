            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Liste des Familles</h4> </div>
                ...
                <div class="row">
                 ...
                 <div class="col-sm-8">
					...
					<tr>
						<td><c:out value="${famille.nom_famille}" /></td>
						<td><c:out value="${famille.description}" /></td>
					<td>
						<c:url value="/template/pages/detail-famille.jsp" var="update_url">
								<c:param name="id" value="${famille.id}" />
						</c:url> 
						...
						<c:url value="/template/pages/modifier-famille.jsp" var="update_url">
								<c:param name="id" value="${famille.id}" />
						</c:url> 
							<a href="<c:out value="${update_url}" />" >
						...
						<c:url value="/template/pages/delete_famille.jsp" var="delete_url">
								<c:param name="id" value="${famille.id}" />
						</c:url> 
