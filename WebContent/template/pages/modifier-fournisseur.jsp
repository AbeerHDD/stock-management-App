...
<div class="navbar-default sidebar" role="navigation">
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Modifier fournisseur</h4> </div>
                 ...
                 <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <input class="form-control" type="hidden" name="id" value="${fournisseur.id}">
                                <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Code :</label>
                            <input class="form-control" type="text" name="code" value="${fournisseur.code}" placeholder="Code" required> </div>
                    </div>
                               
                              <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Raison Sociale :</label>
                            <input class="form-control" type="text" name="raison_sociale" value="${fournisseur.raison_sociale}"  placeholder="Raison Sociale"> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Résponsable :</label>
                            <input class="form-control" type="text" name="responsable" value="${fournisseur.responsable}" placeholder="Résponsable"> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                        <label>Matricule Fiscale :</label>
                            <input class="form-control" type="text" name="matricule_fiscale" value="${fournisseur.matricule_fiscale}" placeholder="Matricule Fiscale"> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                        <label>Téléphone :</label>
                            <input class="form-control" type="number" min="20000000" max="99999999" name="telephone" value="${fournisseur.telephone}" placeholder="Téléphone"> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                        <label>Fax :</label>
                            <input class="form-control" type="number" min="20000000" max="99999999" name="fax" value="${fournisseur.fax}"  placeholder="Fax"> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                        <label>Email :</label>
                            <input class="form-control" type="email" name="email" value="${fournisseur.email}" placeholder="Email"> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label> Adresse :</label>
                            <input class="form-control" type="text" name="adresse" value="${fournisseur.adresse}"  placeholder="Adresse"> </div>
                    </div>
  ...
  <option value="ben arous">Ban Arous</option>
  ...
  <option value="zaghouane">Zaghouane</option>
                    ...
                    <div class="form-group m-t-20">
                        ...
                        <label>Code Postal :</label>
                            <input class="form-control" type="number" name="code_postal" value="${fournisseur.code_postal}"  placeholder="Code Postal"> </div>
                    </div>
   ...
   <option  >Mode de Paiement Préféré</option>                 
