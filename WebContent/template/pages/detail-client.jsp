...
select * from client where id = '<c:out value="${param.id}" />' ; 
</sql:query>
    <!-- Preloader -->
    <div class="preloader">
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Détails d'un Client</h4> </div>
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                          ...
                          <c:forEach var="client" items="${list.rows}">
                            ...
                            <form class="form-material form-horizontal" action="update_article.jsp" method="POST" >
                               
                           
                  <h5 class="box-title m-t-40 m-b-0">Détails d'un Client</h5>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                           <label>Nom :</label>
                            <input class="form-control" type="text" name="client.nom" value="<c:out value="${client.nom}"/>" placeholder="Nom" disabled> </div>
                    </div> 
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Prénom :</label>
                            <input class="form-control" type="text" name="prenom" value="<c:out value="${client.prenom}"/>" placeholder="Prénom" disabled> </div>
                    </div>
...
<div class="form-group m-t-20">
                        ...
                        <div class="col-xs-12">
                            ...
                            <input class="form-control" type="text" name="matricule_fiscale" value="<c:out value="${client.matricule_fiscale}"/>" placeholder="Matricule Fiscale" disabled> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Téléphone :</label>
                            <input class="form-control" type="tel" name="telephone" value="<c:out value="${client.telephone}"/>" placeholder="Téléphone" disabled> </div>
                    </div>
                    <div class="form-group ">
                        <div class="col-xs-12">
                          <label>Email :</label>
                            <input class="form-control" type="text" name="email" value="<c:out value="${client.email}"/>" placeholder="Email" disabled> </div>
                    </div>
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <label>Adresse :</label>
                            <input class="form-control" type="text" name="adresse" value="<c:out value="${client.adresse}"/>" placeholder="Adresse" disabled> </div>
                    </div>
                    <div class="form-group ">
                        <div class="col-xs-12">
                           <label>Ville :</label>
                            <input class="form-control" type="text" name="adresse" value="<c:out value="${client.ville}"/>" placeholder="Adresse" disabled> </div>
                    </div>
                     <div class="form-group ">
                    <div class="col-xs-12">
                          <label>Code Postal :</label>
                            <input class="form-control" type="text" name="code_postal" value="<c:out value="${client.code_postal}"/>" placeholder="Code Postal" disabled> </div>
