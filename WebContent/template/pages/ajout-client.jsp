            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Ajouter un Client</h4> </div>
                 ...
                 <div class="col-sm-8">
                        <div class="white-box">
                            ...
                            <form class="form-material form-horizontal" action="add_client.jsp" method="POST">
                               
                           
                  <h5 class="box-title m-t-40 m-b-0">Ajouter un Client</h5>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <input class="form-control" type="text"  placeholder="Nom" name="nom"> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
...
<div class="form-group m-t-20">
                        ...
                        <div class="col-xs-12">
                            <input class="form-control" type="text"  placeholder="Matricule Fiscale" name="matricule_fiscale"> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <input class="form-control" type="number" min="20000000" max="99999999"   placeholder="Téléphone" name="telephone"> </div>
                    </div>
                    ...
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input class="form-control" type="text" placeholder="Adresse" name="adresse"> </div>
                    </div>
  ...
  <option value="zaghouane">Zaghouane</option>
               ...
               <div class="form-group text-center m-t-20">
                    <div class="col-xs-12">
                            <input class="form-control" type="number" placeholder="Code Postal" name="code_postal"> </div>
                    </div>
