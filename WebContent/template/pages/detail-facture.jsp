...
select * from facture where id = '<c:out value="${param.id}" />' ; 
</sql:query>
    <!-- Preloader -->
    <div class="preloader">
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Détails d'une Facture</h4> </div>
                   ...
                   <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Détails d'une Facture</h3>
                           
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                
                                 <c:forEach var="facture" items="${list.rows}">
                    ...
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            ...
                            <input class="form-control" type="number" name="id_commande" value="<c:out value="${facture.id_commande}"/>"  placeholder="Désignation" disabled> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Libillé :</label>
                            <input class="form-control" type="number" name="numfacture" value="<c:out value="${facture.numfacture}" />" placeholder="Libillé" disabled> </div>
                    </div>
                  <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <label>Unité :</label>
                            <input class="form-control" type="text" name="client" value="<c:out value="${facture.client}" />" placeholder="Libillé" disabled> </div>
                    </div>
                  
                  <div class="form-group m-t-20">
                        <div class="col-xs-12">
                           <label>Quantité :</label>
                            <input class="form-control" type="text" name="date" value="<c:out value="${facture.date}" />" placeholder="Quantité" disabled> </div>
                    </div>
                   <div class="form-group m-t-20">
                        <div class="col-xs-12">
                           <label>Famille :</label>
                            <input class="form-control" type="text" name="articles" value="<c:out value="${facture.articles}" />" placeholder="famille" disabled> </div>
                    </div>
                  <div class="form-group m-t-20">
                        <div class="col-xs-12">
                           <label> Sous Famille :</label>
                            <input class="form-control" type="text" name="prix" value="<c:out value="${facture.prix}" />" placeholder="sous_famille" disabled> </div>
                    </div>
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                           <label> Paiement :</label>
                            <input class="form-control" type="text" name="paiement" value="<c:out value="${facture.paiement}" />" placeholder="sous_famille" disabled> </div>
                    </div>
