...
<head>
    ...
    <title>Ajouter Sous Famille</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Ajouter Sous Famille</h4> </div>
                 ...
                 <div class="col-sm-8">
                        <div class="white-box">
                            <h3 class="box-title">Ajouter Sous Famille</h3>
                            <form class="form-material form-horizontal" action="add_sous_famille.jsp" method="POST">
                                <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <input class="form-control" type="text" name="nom_sous_famille" placeholder="Nom de sous la famille"> </div>
                    </div>
