...
<div class="navbar-default sidebar" role="navigation">
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Ajouter une Facture</h4> </div>
                 ...
                 <div class="col-sm-8">
                        <div class="white-box">
                            <h3 class="box-title">Ajouter une Facture</h3>
                            <form class="form-material form-horizontal" action="add_facture.jsp" method="POST">
                                <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <input class="form-control" type="text" name="id_commande" placeholder="ID Commande"> </div>
                    </div>
                              <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <input class="form-control" type="text" name="numfacture" placeholder="Num Facture"> </div>
                    </div>  
  ...
  <option value="<c:out value="${client.nom}"/>" value="<c:out value="${client.prenom}"/>"><c:out value="${client.nom}" /> <c:out value="${client.prenom}" />  </option> 
                    ...
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <input class="form-control" type="text" name="articles" placeholder="Articles"> </div>
                    </div>  
                    
                    <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <input class="form-control" type="number" name="prix" placeholder="Prix"> </div>
                    </div>  
