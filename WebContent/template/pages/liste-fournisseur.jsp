            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Liste des Fournisseur</h4> </div>
                                ...
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                           ...
                                           <tr>
                        <td><c:out value="${fournisseur.code}" /></td>
						<td><c:out value="${fournisseur.raison_sociale}" /></td>
						<td><c:out value="${fournisseur.responsable}" /></td>
						<td><c:out value="${fournisseur.email}" /></td>
						<td><c:out value="${fournisseur.telephone}" /></td>
						
					<td>
						<c:url value="/template/pages/detail-fournisseur.jsp" var="update_url">
								<c:param name="id" value="${fournisseur.id}" />
						</c:url> 
						...
						<c:url value="/template/pages/modifier-fournisseur.jsp" var="update_url">
								<c:param name="id" value="${fournisseur.id}" />
						</c:url> 
							<a href="<c:out value="${update_url}" />" >
						...
						<c:url value="/template/pages/delete_fournisseur.jsp" var="delete_url">
								<c:param name="id" value="${fournisseur.id}" />
						</c:url> 
