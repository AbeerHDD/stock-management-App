            ...
            <div class="container-fluid">
                ...
                <div class="row">
                 ...
                 <div class="col-sm-8">
					...
					<tr>
						<td><c:out value="${commande.numcommande}" /></td>
						<td><c:out value="${commande.id_devis}" /></td>
						<td><c:out value="${commande.client}" /></td>
						<td><c:out value="${commande.date}" /></td>
					<td>
						<c:url value="/template/pages/detail-commande.jsp" var="update_url">
						...
						<c:url value="/template/pages/modifier-commande.jsp" var="update_url">
								<c:param name="id" value="${commande.id}" />
						</c:url> 
							<a href="<c:out value="${update_url}" />" >
						...
						<c:url value="/template/pages/delete_commande.jsp" var="delete_url">
								<c:param name="id" value="${commande.id}" />
						</c:url> 
