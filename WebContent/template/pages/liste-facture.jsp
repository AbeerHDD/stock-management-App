            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Liste des Factures</h4> </div>
                ...
                <div class="row">
                 ...
                 <div class="col-sm-8">
					...
					<tr>
						<td><c:out value="${facture.id_commande}" /></td>
						<td><c:out value="${facture.numfacture}" /></td>
						<td><c:out value="${facture.client}" /></td>
						<td><c:out value="${facture.prix}" /></td>
						<td><c:out value="${facture.paiement}" /></td>
					<td>
						<c:url value="/template/pages/detail-facture.jsp" var="update_url">
								<c:param name="id" value="${facture.id}" />
						</c:url> 
						...
						<c:url value="/template/pages/modifier-facture.jsp" var="update_url">
								<c:param name="id" value="${facture.id}" />
						</c:url> 
							<a href="<c:out value="${update_url}" />" >
						...
						<c:url value="/template/pages/delete_facture.jsp" var="delete_url">
								<c:param name="id" value="${facture.id}" />
						</c:url> 
