                ...
                <div class="row bg-title">
                 ...
                 <div class="col-sm-8">
                        <div class="white-box">
                            ...
                            <form class="form-material form-horizontal" action="add_commande.jsp" method="POST">
                            <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <input class="form-control" type="number" name="id_devis" placeholder="ID Devis"> </div>
                    </div>
                                <div class="form-group m-t-20">
                        <div class="col-xs-12">
                            <input class="form-control" type="number" name="numcommande" placeholder="Num Commande"> </div>
                    </div>
